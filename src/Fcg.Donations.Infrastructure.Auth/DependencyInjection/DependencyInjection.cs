...
using Fcg.Donations.Application.Settings;
using Fcg.Donations.Infrastructure.Auth.Authentication;
...
namespace Fcg.Donations.Infrastructure.Auth.DependencyInjection;
